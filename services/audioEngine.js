...
class AudioEngine {
    constructor() {
        ...
        this.armedTrack = null; // Track index currently recording
    ...
    async init() {
        ...
        // Setup Recorder
        this.recorderNode = new AudioWorkletNode(this.ctx, 'recorder-worklet-processor');
        this.recorderNode.port.onmessage = (e) => {
            if (this.isRecording && this.armedTrack !== null) {
                ...
                if (left && frameNumber !== undefined) {
                    ...
                    this.writeToBuffer(this.armedTrack, Math.round(relativeFrame), left, right);
                }
            }
        };
    ...
    async initInput(deviceId = null) {
        ...
        try {
            ...
            // Connect recorder
            if (this.recorderNode) this.inputSource.connect(this.recorderNode);
